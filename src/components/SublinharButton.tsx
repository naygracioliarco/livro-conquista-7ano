interface SublinharButtonProps {
    onClick: () => void;
    disabled?: boolean;
  }
  
  function SublinharButton({ onClick, disabled = false }: SublinharButtonProps) {
    return (
      <div className="flex">
        <button
          onClick={onClick}
        ...
        >
          <div
            style={{
              ...
              justifyContent: 'center',
              zIndex: 1,
              background: 'transparent url("images/iconSublinhar.png") no-repeat center',
              backgroundSize: '100%',
            }}
          >
          </div>
  ...
  export default SublinharButton;
